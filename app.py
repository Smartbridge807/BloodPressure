...
precautions_dict = {
    0: [
        ...
        "Monitor blood pressure once a month."
    ],
    1: [
    ...
    2: [
        "Consult a doctor for intensive management.",
        "Strictly follow prescribed medications.",
        "Check BP daily and maintain a log.",
        "Avoid heavy physical exertion unless advised.",
        "Immediate lifestyle changes are mandatory."
    ]
}
...
def home():
    ...
    if request.method == 'POST':
        ...
        precautions = precautions_dict.get(pred, [])

    return render_template('index.html', prediction_text=prediction_text, precautions=precautions)
